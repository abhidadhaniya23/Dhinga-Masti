...
const TeamCards = () => {
    return (
        <>
         <div className="flex flex-wrap lg:first:ml-32">
            <div className=" lg:w-[34rem] w-72 -ml-24 lg:ml-0 rounded-xl overflow-hidden bg-gray-200/80 backdrop-blur-3xl lg:mr-8 mb-8">
