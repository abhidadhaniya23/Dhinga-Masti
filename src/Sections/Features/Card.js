...
const Card = () => {
    ...
    return (
        <div className="bg-gray-400  bg-opacity-30 sm:mt-28 sm:px-8 sm:pt-16 lg:w-80 lg:h-[21rem] w-96 h-[15rem] sm:pb-24 m-5 text-center relative rounded-2xl">
            ...
            <h2 className="text-3xl lg:mt-10 ">xyz</h2>
            ...
            <p className="leading-relaxed text-xs sm:text-base sm:mt-4 mt-2 mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat Photo booth fam kinfolk cold-pressed srir</p>
        </div>
    );
};
