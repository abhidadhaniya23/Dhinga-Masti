...
const GamesCards = () => {
    ...
    return (
        <div className="bg-white sm:w-[56rem] sm:h-[14rem] w-80  h-[8rem]  flex flex-row m-4 sm:ml-80 ml-12  sm:mt-14 mt-12 odd:flex-row-reverse rounded-xl overflow-hidden">
